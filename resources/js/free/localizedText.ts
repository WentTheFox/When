 ...
 * ActivityLocalization.label): a required `default` key plus any number of
...
export interface LocalizedText {
  /** Required at the DB/validation layer for an ActivityLocalization's own label; left optional here since Public page title's own 'default' is allowed to stay blank (falls through to a computed default instead). */
  default?: string;
