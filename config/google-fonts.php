...
return [
     ...
     *
     * 'default' mirrors WentTheNuxt's own brand font choice exactly (its
     * nuxt.config.ts googleFonts.families: Catamaran, weights 400/700) —
     * see resources/css/app.css's --bs-font-sans-serif override for how
     * it's actually applied once loaded.
     */
    'fonts' => [
        'default' => 'https://fonts.googleapis.com/css2?family=Catamaran:wght@400;700&display=swap',
    ],
