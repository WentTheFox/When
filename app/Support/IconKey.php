...
enum IconKey: string
{
    ...
    public function categories(): array
    {
        return match ($this) {
            ...
            self::Heart, self::Gift => ['highlighted'],
            self::Flag => ['highlighted', 'public'],
            self::Users, self::Handshake, self::PeopleGroup => ['work', 'highlighted', 'public'],
            self::Bell => ['busy', 'highlighted', 'public'],
